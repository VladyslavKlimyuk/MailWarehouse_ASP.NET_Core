...
public class UserViewModel
{
    ...
    [Display(Name = "Ім'я", ResourceType = typeof(UserViewModel))]
    ...
    [Display(Name = "Прізвище", ResourceType = typeof(UserViewModel))]
    ...
    [Display(Name = "Email", ResourceType = typeof(UserViewModel))]
    [Required(ErrorMessage = "Email обов'язковий для заповнення.")]
    [EmailAddress(ErrorMessage = "Некоректний формат email.")]
    public string Email { get; }

    [Display(Name = "Номер телефону", ResourceType = typeof(UserViewModel))]
